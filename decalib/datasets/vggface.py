...
class VGGFace2Dataset(Dataset):
    def __init__(self, K, image_size, scale, trans_scale = 0, isTemporal=False, isEval=False, isSingle=False):
        ...
        self.imagefolder = 'train_data/vggface2/data/train_sample_2'
        self.kptfolder = 'train_data/vggface2/data/train_sample_2'
        self.segfolder = 'train_data/vggface2/data/train_sample_2'
        # hq:
        ...
        datafile = 'train_data/vggface2/data/train_list_sample_2.txt'
        if isEval:
            datafile = 'train_data/vggface2/data/train_list_sample_2.txt'
        ...
        for line in lines:
            ...
            if line:
                folder, image = line.split("/")  # 分割前缀文件夹和图片名称
        ...
        # 统计文件夹和图片数量
        a = len(data)  # 前缀文件夹的数量
        b = max(len(images) for images in data.values())  # 每个文件夹中图片的最大数量

        # 构建 NumPy 数组
        result = np.empty((a, b), dtype=object)  # 使用 object 类型存储字符串
        for i, (folder, images) in enumerate(data.items()):
            for j, image in enumerate(images):
                image_name = image.split(".")[0]  # 去除后缀
                result[i, j] = f"{folder}/{image_name}"  # 拼接前缀文件夹和图片名称

        print("data数组的形状:", result.shape)

        self.data_lines = result

        # self.data_lines = [["n000002/0001_01.jpg","n000002/0002_01.jpg","n000002/0003_01.jpg","n000002/0004_01.jpg","n000002/0005_01.jpg"],
        #                    ["n000003/000_01.jpg","n000003/0002_01.jpg","n000003/0003_01.jpg","n000003/0004_01.jpg","n000003/0005_01.jpg"]]
